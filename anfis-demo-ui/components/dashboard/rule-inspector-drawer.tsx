  ...
  return (
    <Drawer>
      <DrawerTrigger asChild>
        <Button variant="outline" size="sm" className="hidden lg:flex gap-2 border-slate-700 bg-slate-800/50 hover:bg-slate-800 text-slate-300">
        ...
        <div className="mx-auto w-full max-w-4xl p-6">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
             ...
             <div className="md:col-span-2">
                ...
                <ScrollArea className="h-[400px] rounded-lg border border-slate-800 bg-slate-900/30 p-4">
